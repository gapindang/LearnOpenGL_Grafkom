...
int main()
{
    ...
    // ========== ATMOSPHERE SETTINGS ==========
    // Uncomment the atmosphere you want to use:
    ...
    glm::vec3 bgColor = glm::vec3(0.75f, 0.52f, 0.3f); // Warm sandy background
    glm::vec3 dirAmbient = glm::vec3(0.3f, 0.24f, 0.14f);
    glm::vec3 dirDiffuse = glm::vec3(0.7f, 0.42f, 0.26f);
    glm::vec3 spotDiffuse = glm::vec3(0.8f, 0.8f, 0.0f);
    glm::vec3 spotSpecular = glm::vec3(0.8f, 0.8f, 0.0f);
    float spotLinear = 0.09f;
    float spotQuadratic = 0.032f;

    /* FACTORY ATMOSPHERE (commented out)
    glm::vec3 pointLightColors[] = {
    ...
    glm::vec3 dirAmbient = glm::vec3(0.05f, 0.05f, 0.1f);
    glm::vec3 dirDiffuse = glm::vec3(0.2f, 0.2f, 0.7f);
    glm::vec3 spotDiffuse = glm::vec3(1.0f, 1.0f, 1.0f);
    glm::vec3 spotSpecular = glm::vec3(1.0f, 1.0f, 1.0f);
    float spotLinear = 0.009f;
    float spotQuadratic = 0.0032f;
    */

    /* HORROR ATMOSPHERE (commented out)
    glm::vec3 pointLightColors[] = {
    ...
    glm::vec3 dirAmbient = glm::vec3(0.0f, 0.0f, 0.0f);
    glm::vec3 dirDiffuse = glm::vec3(0.05f, 0.05f, 0.05f);
    glm::vec3 spotDiffuse = glm::vec3(1.0f, 1.0f, 1.0f);
    glm::vec3 spotSpecular = glm::vec3(1.0f, 1.0f, 1.0f);
    float spotLinear = 0.09f;
    float spotQuadratic = 0.032f;
    */
    ...
    /* BIOCHEMICAL LAB ATMOSPHERE (commented out)
    glm::vec3 pointLightColors[] = {
    ...
    glm::vec3 bgColor = glm::vec3(0.9f, 0.9f, 0.9f);
    glm::vec3 dirAmbient = glm::vec3(0.5f, 0.5f, 0.5f);
    glm::vec3 dirDiffuse = glm::vec3(1.0f, 1.0f, 1.0f);
    glm::vec3 spotDiffuse = glm::vec3(0.0f, 1.0f, 0.0f);
    glm::vec3 spotSpecular = glm::vec3(0.0f, 1.0f, 0.0f);
    float spotLinear = 0.07f;
    float spotQuadratic = 0.017f;
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        */
        ...
        lightingShader.setVec3("spotLight.diffuse", spotDiffuse);
        lightingShader.setVec3("spotLight.specular", spotSpecular);
